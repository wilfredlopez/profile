...
const Logo = ({ width = 35, height = 'auto' }: Props) => {
    return (
        <svg width={width} viewBox="0 0 68 66" style={{ height }}>
            ...
            <text id="W" transform="matrix(1, 0.017, -0.017, 1, 18.872, 28.632)" fill="#ff9b9b" font-size="22" font-family="Poppins-Black, Poppins" font-weight="800" letter-spacing="0.316em"><tspan x="0" y="0">W</tspan></text>
            <text id="L" transform="matrix(1, 0.017, -0.017, 1, 37.872, 55.632)" fill="#ff9b9b" font-size="22" font-family="Poppins-Black, Poppins" font-weight="800" letter-spacing="0.316em"><tspan x="0" y="0">L</tspan></text>
        </svg>
